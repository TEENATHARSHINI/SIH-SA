...
def add_government_theme():
    """Add government website theme CSS with dark/light mode support"""
    st.markdown("""
    <style>
...
def add_theme_toggle():
    ...
    st.markdown(
        ...
        // Update theme when session state changes
        const observer = new MutationObserver(function(mutations) {{
            mutations.forEach(function(mutation) {{
                if (mutation.attributeName === 'data-theme') {{
                    document.documentElement.setAttribute('data-theme', mutation.target.getAttribute('data-theme'));
                }}
            }});
        }});
